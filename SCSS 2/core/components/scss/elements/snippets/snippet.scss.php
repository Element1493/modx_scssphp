...
$options['componentPath'] 	            = $modx->getOption($options['nameoptions'].'component_path', null, $options['corePath'].'components/'.$options['name'] .'/');
$options['vendorPath'] 		            = $modx->getOption($options['nameoptions'].'vendor_path', null, $options['componentPath'] . 'vendor/');
$options['basePath'] 		            = $modx->getOption($options['nameoptions'].'base_path', null, $modx->getOption('base_path'));
$options['baseUrl'] 		            = $modx->getOption($options['nameoptions'].'base_url', null, $modx->getOption('base_url'));
$options['siteUrl'] 		            = $modx->getOption($options['nameoptions'].'site_url', null, $modx->getOption('site_url'));
$options['assetsUrl']  		            = $modx->getOption($options['nameoptions'].'assets_url', null, $modx->getOption('assets_url'));
$options['admin'] 			            = $modx->getOption($options['nameoptions'].'admin', null, $scriptProperties['admin']);
$options['fileScss']                    = $modx->getOption($options['nameoptions'].'fileScss', null, $scriptProperties['fileScss']);
$options['fileCss']                     = $modx->getOption($options['nameoptions'].'fileCss', null, $scriptProperties['fileCss']);
$options['importPaths']                 = $modx->getOption($options['nameoptions'].'importPaths', null, $scriptProperties['importPaths']);
$options['outputStyle']  	            = $modx->getOption($options['nameoptions'].'outputStyle', null, $scriptProperties['outputStyle']);
$options['sourceMap'] 	                = $modx->getOption($options['nameoptions'].'sourceMap', null,$scriptProperties['sourceMap']);
$options['scssHash'] 	                = $modx->getOption($options['nameoptions'].'scssHash', null,$scriptProperties['scssHash']);
$options['autoprefixer'] 	            = $modx->getOption($options['nameoptions'].'autoprefixer', null,$scriptProperties['autoprefixer']);
$options['autoprefixerVendor']          = $modx->getOption($options['nameoptions'].'autoprefixerVendor', null,$scriptProperties['autoprefixerVendor']);
$options['fileHash']                    = $modx->getOption($options['nameoptions'].'fileHash', null, $options['corePath'] . 'cache/scss/'.$options['fileScss'].'.txt');
